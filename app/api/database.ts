...
export const updateUserPreco = async (
  userId: string | null,
  valor: string | number
) => {
  try {
...
export const updateUserBloqueio = async (
  userId: string | null,
  bloqueio: boolean
) => {
  try {
...
export const sendRequestTreinoF = async (
  data: string,
  treino: string,
  uid: string | null
) => {
  try {
    await axios.post(
      `https://backend-production-22a2.up.railway.app/GerarDietaTreinoF`,
      { data: data, treino: treino, uid: uid }
    );
    return;
  } catch (error) {
...
export const sendRequestTreinoM = async (
  data: string,
  treino: string,
  uid: string | null
) => {
  try {
    await axios.post(
      `https://backend-production-22a2.up.railway.app/GerarDietaTreinoM`,
      { data: data, treino: treino, uid: uid }
    );
    return;
  } catch (error) {
...
export const sendRequest = async (data: string, uid: string | null) => {
  try {
    await axios.post(
      `https://backend-production-22a2.up.railway.app/GerarDieta`,
      { data: data, uid: uid }
    );
    return;
  } catch (error) {}
